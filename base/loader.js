...
const url = process.argv[2] || "https://yzvw15p285.execute-api.us-east-1.amazonaws.com/Prod/product"
const CF_URL = "https://d372oiw8ng34xu.cloudfront.net/"
console.log(url);
...
csv()
    ...
    .then((products) => {
        ...
        var params = {
            Name: '/boppis/resources/s3', /* required */
            WithDecryption: false
        };
        ssm.getParameter(params).promise().then(parameterData => {
            ...
            for (let product of products) {
                ...
                if(!base64.startsWith('http')){
                    ...
                    let s3Params = {
                        Bucket: parameterData.Parameter.Value,
                        Key: imagePath,
                        Body: buf
                    }
                ...
                promises.push(axios.put(url, product_data))
